...
#         with open(f"{self.log_dir}/f_score_log_{epoch}.txt", "w") as f:
#             for score in self.f_scores:
#                 f.write(f"{score}\n")

#     def plot_f_scores(self):
#         plt.figure()
#         plt.plot(range(len(self.f_scores)), self.f_scores, label="F-Score")
#         plt.title("F-Score during Training")
#         plt.xlabel("Epoch")
#         plt.ylabel("F-Score")
#         plt.legend()
#         plt.savefig(f"{self.log_dir}/f_score_plot.png")
#         plt.close()
